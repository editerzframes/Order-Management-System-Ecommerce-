...
$sql = "SELECT * FROM customers WHERE customer_id='".$var1."'";
$result = $db->query($sql);
    ...
    <div class="wrapper ">
        ...
        <div class="main-panel">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card ">
                  <form action="updateCF.php" method="post" enctype="multipart/form-data">
                <div class="card-body ">
                    ...
                    <div class="form-group">
                      <input type="text"  id="company" name="company" value= "<?php echo $company ?>" class="form-control">
                    </div>
