...
if ($result->num_rows > 0) {
    ...
    echo "<table class='".$st1."' id='".$st2."'>";
     echo "<thead>";
    echo "<tr><th>ID</th><th>Product Name</th><th>RRP</th><th>Product Price</th><th>Product Status</th><th>Catagory</th><th>Action</th></tr>";
     echo "</thead>";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        $func1 = 'http://meritech.co.ug/asif/dashboard/admin/EditProduct.php?value='.$row["product_id"];
        $func2 = 'http://meritech.co.ug/asif/dashboard/admin/DeleteProduct.php?value='.$row["product_id"];
        $i1 = 'nc-icon nc-check-2';
        $i2 = 'nc-icon nc-simple-remove';
        $delete ='myown('. $row["product_id"].')';
...
function okPressed(clicked_id){
    ...
    window.location = "http://meritech.co.ug/asif/dashboard/admin/DeleteProduct.php?value="+clicked_id;
