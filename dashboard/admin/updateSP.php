...
$lpass = mysqli_real_escape_string($db, $lpass);
            ...
            $insert = mysqli_query($db, "UPDATE salesperson SET salesperson_name = '".$name."', status = '".$status."', email = '".$email."', number = '".$number."',address = '".$add."',l_email = '".$lemail."',l_pass = '".$lpass."' WHERE salesperson_id = '".$id."'") or die(mysqli_error($db));
