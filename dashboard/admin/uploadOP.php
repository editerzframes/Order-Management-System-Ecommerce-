...
//include ('session.php');
header('Location: https://www.meritech.co.ug/asif/dashboard/admin/orders.php/');
...
$price = $row34["price"];
        ...
        $insert = mysqli_query($db, "INSERT into order_product (order_id, product_id, quantity, price) VALUES (  '".$oid."', '".$pid."', '".$qua."', '".$price."')")  or die(mysqli_error($db));
    ...
    $insert1 = mysqli_query($db, "INSERT into orders (customer_id, total, status, time, order_by) VALUES (  '".$id."', '".$total."', 'Pending', NOW(), 'Admin')")  or die(mysqli_error($db));
