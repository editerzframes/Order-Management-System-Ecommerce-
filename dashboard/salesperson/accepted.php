...
header('Location: http://meritech.co.ug/asif/dashboard/salesperson/orders.php/');

$statusMsg = '';

$id = $_GET['value'];

            $insert = mysqli_query($db, "UPDATE orders SET status = 'Accepted' WHERE order_id = '".$id."'") or die(mysqli_error($db));
