...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">RAA Limited - Order Management System</a>
          </div>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link btn-magnify" href="http://meritech.co.ug/asif/dashboard/admin/logout.php">
      ...
      <div class="content">
        <h2>Orders</h2>
        <button style="margin-bottom: 50px; border: none; background: white;padding: 10px 20px; border-radius: 20px; box-shadow: 5px 5px 5px gray ; outline: none;"><a href="https://meritech.co.ug/asif/dashboard/salesperson/NewOrder.php" style="text-decoration: none; color: black;">Add Orders</a></button>
...
if ($result->num_rows > 0) {
    ...
    echo "<table class='".$st1."' id='".$st2."'>";
     echo "<thead>";
    echo "<tr><th>ID</th><th>Customer Name</th><th>Customer Email</th><th>Order Total</th><th>Order By</th><th>Order Status</th><th>Order Time</th><th>Action</th></tr>";
     echo "</thead>";
...
$cemail = $row45["email"];
    ...
    if($soid == $sid){
       ...
       $st3 = 'color: green';
        $st4 = 'color: red';
        $st5 = 'color: blue';
        $func1 = 'http://meritech.co.ug/asif/dashboard/salesperson/accepted.php?value='.$row["order_id"];
        $func2 = 'http://meritech.co.ug/asif/dashboard/salesperson/decline.php?value='.$row["order_id"];
        $func3 = 'http://meritech.co.ug/asif/dashboard/salesperson/EditOrder.php?value='.$row["order_id"];
...
function okPressed(clicked_id){
    ...
    window.location = "http://meritech.co.ug/asif/dashboard/salesperson/DeleteOrder.php?value="+clicked_id;
